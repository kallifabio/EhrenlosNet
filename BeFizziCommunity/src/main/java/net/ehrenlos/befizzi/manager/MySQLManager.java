...
public class MySQLManager {
    ...
    public void openConnection() throws SQLException, ClassNotFoundException {
        ...
        synchronized (this) {
            ...
            Bukkit.getConsoleSender().sendMessage(Community.getPrefix() + "MySQL ist verbunden");
        }
    }
    //</editor-fold>
    ...
    public void closeConnection() {
        if (isConnected()) {
            try {
                connection.close();
                Bukkit.getConsoleSender().sendMessage(Community.getPrefix() + "MySQL ist geschlossen");
            } catch (SQLException e) {
                e.printStackTrace();
            }
        }
